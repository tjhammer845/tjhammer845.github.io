...
class App extends React.Component {
    state = {
        ...
        headerLinks: [
            { title: 'Home', path: '/tjhammer845.github.io' },
        ...
        return (
            <Router>
                <Container className='main-container' fluid={true}>
                    <Sticky {...this.state} />
                    <Route path='/tjhammer845.github.io' exact render={() => <HomePage title={this.state.home.title} subTitle={this.state.home.subTitle} text={this.state.home.text} />} />
