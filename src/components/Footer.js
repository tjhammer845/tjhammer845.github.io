            ...
            <Container fluid={true}>
                <Row className='justify-content-md-between p-3'>
                    ...
                    <Col className='d-flex justify-content-center justify-content-md-end p-0' md={6} sm={12}>
                        <font className='text-center align-self-center text-sm-left'>&copy; {new Date().getFullYear()} Tom Hammer. <span className='text-nowrap'>All Rights Reserved.</span></font>
                    </Col>
                </Row>
            </Container>
        </footer>
